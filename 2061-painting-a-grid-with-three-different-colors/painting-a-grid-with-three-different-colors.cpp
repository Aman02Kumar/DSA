...
public:
    ...
    //preparing the vector store along side the column
    ...
    int colorTheGrid(int m, int n) {
        ...
        //mapping => index to {vector of indices which can to adjacen to index}
        ...
        //dp[length][index] = no of possibilities when the length in length and the lase element is store[index]
